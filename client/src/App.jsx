...
function App() {
  startButton = React.useRef(null);
  hangupButton = React.useRef(null);
  muteAudButton = React.useRef(null);
  localVideo = React.useRef(null);
  remoteVideo = React.useRef(null);
  React.useEffect(() => {
    hangupButton.current.disabled = true;
    muteAudButton.current.disabled = true;
  }, []);
  const [audiostate, setAudio] = React.useState(false);
